...
/***/ function(module, exports) {
	...
	var config = {
	  apiOrigins: {
	    production: 'https://still-brook-29028.herokuapp.com/'
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var clearModals = function clearModals(event) {
	  var selector = '#' + event.target.id + '> div > div > .modal-body > form';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var changePassFailure = function changePassFailure(error) {
	  utils.clearErrorMessage('#change-password');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var clearModalInput = function clearModalInput(element) {
	  $(element + ' > fieldset > label > input').val('');
	};

	var addErrorMessage = function addErrorMessage(element, status) {
	  var html = '<p class="modal-error">';
	  switch (status) {
	    case 401:
	...
	var clearErrorMessage = function clearErrorMessage(element) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var exploreBooksLanding = __webpack_require__(41);

	var onGetList = function onGetList(event) {
	  event.preventDefault();
	  $('#list').empty();
	  api.getLists().then(ui.readingDisplay).catch(ui.onFailure);
	};
	...
	var onGetBooks = function onGetBooks(event) {
	  ...
	  if (data.title || data.author) {
	    api.searchBooks(data).then(ui.exploreBooks).catch(ui.onFailure);
	  } else {
	    api.indexBooks().then(ui.exploreBooks).catch(ui.onFailure);
	  }
	};

	var onExploreBooks = function onExploreBooks(event) {
	  event.preventDefault();
	  $('#list').empty();
	  ...
	  $('#newBookForm').on('submit', function (event) {
	    event.preventDefault();
	    var data = getFormFields(event.target);
	    api.createBook(data).then(ui.onCreationSuccess).catch(ui.onCreationFailure);
	  });
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var updateBook = function updateBook(data, id) {
	  return $.ajax({
	    url: config.apiOrigin + '/books/' + id,
	    method: 'PATCH',
	    headers: {
	...
	var showReading = function showReading(id) {
	  return $.ajax({
	...
	var createReading = function createReading(book) {
	  var data = {
	    reading: {
	      book_id: book,
	      list: 'default',
	...
	var deleteReading = function deleteReading(id) {
	  return $.ajax({
	    url: config.apiOrigin + '/readings/' + id,
	    method: 'DELETE',
	    headers: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var displayList = __webpack_require__(16);
	var readingList = __webpack_require__(38);
	var listEntry = __webpack_require__(36);
	var readingListEntry = __webpack_require__(39);
	var addReading = __webpack_require__(37);

	var onFailure = function onFailure(error) {
	  console.error(error);
	};

	var onCreationFailure = function onCreationFailure(error) {
	  utils.addErrorMessage('#newBookForm', error.status);
	  console.error(error);
	};

	var onCreationSuccess = function onCreationSuccess(data) {
	  ...
	  var newBookHtml = listEntry({ book: data.book }) + addReading({ book: data.book });
	  ...
	  $('#add' + data.book.id).on('click', function (event) {
	    event.preventDefault();
	    api.createReading(event.target.dataset.book).then().catch(onFailure);
	  });
	};
	...
	var exploreBooks = function exploreBooks(data) {
	  ...
	  $('.addReading').on('click', function (event) {
	    event.preventDefault();
	    api.createReading(event.target.dataset.book).then(function () {
	...
	var readingDisplay = function readingDisplay(data) {
	  // construct html for list to display based on response from server
	  var bookListHtml = readingList({ readings: data.readings });
	  // inject new html into list container
	  ...
	  $('.removeReading').on('click', function (event) {
	    ...
	    api.deleteReading(id).then(function () {
	  ...
	  $('.status-option').on('click', function (event) {
	    event.preventDefault();
	    var id = event.target.dataset.id;
	    var stat = event.target.dataset.status;
	...
	module.exports = {
	  ...
	  onCreationFailure: onCreationFailure,
	  onFailure: onFailure
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n"
	    + ((stack1 = container.invokePartial(__webpack_require__(36),depth0,{"name":"list-entry","hash":{"book":blockParams[0][0]},"data":data,"blockParams":blockParams,"indent":"    ","helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
	    + ((stack1 = container.invokePartial(__webpack_require__(37),depth0,{"name":"add-reading","hash":{"book":blockParams[0][0]},"data":data,"blockParams":blockParams,"indent":"    ","helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
	    + "\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return "<div class=\"book-list\" id=\"bookList\">\n"
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<div data-id=\""
	    ...
	    + "</h4>\n  <p class=\"list-data\">Published In: "
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.book : depth0)) != null ? stack1.published_in : stack1), depth0))
	    + "</p>\n  <p class=\"list-data\">"
	    + ((stack1 = helpers["if"].call(depth0 != null ? depth0 : {},((stack1 = (depth0 != null ? depth0.book : depth0)) != null ? stack1.description : stack1),{"name":"if","hash":{},"fn":container.program(1, data, 0),"inverse":container.program(3, data, 0),"data":data})) != null ? stack1 : "")
	    + "</p>\n</div>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<button type=\"button\" class=\"btn btn-primary addReading\" data-book=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.book : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\" id=\"add-"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.book : depth0)) != null ? stack1.id : stack1), depth0))
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n"
	    + ((stack1 = container.invokePartial(__webpack_require__(39),depth0,{"name":"reading-list-entry","hash":{"reading":blockParams[0][0]},"data":data,"blockParams":blockParams,"indent":"    ","helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
	    + ((stack1 = container.invokePartial(__webpack_require__(40),depth0,{"name":"remove-reading","hash":{"reading":blockParams[0][0]},"data":data,"blockParams":blockParams,"indent":"    ","helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
	    + "\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return "<h2>Your Reading List</h2>\n<div class=\"book-list\" id=\"bookList\">\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.readings : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "</div>\n";
	},"usePartial":true,"useData":true,"useBlockParams":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "\n    "
	    + container.escapeExpression(container.lambda(((stack1 = ((stack1 = (depth0 != null ? depth0.reading : depth0)) != null ? stack1.book : stack1)) != null ? stack1.description : stack1), depth0))
	    + "\n";
	},"3":function(container,depth0,helpers,partials,data) {
	    return "    No description.\n  ";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<div data-id=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.reading : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\" data-book=\""
	    + alias2(alias1(((stack1 = ((stack1 = (depth0 != null ? depth0.reading : depth0)) != null ? stack1.book : stack1)) != null ? stack1.id : stack1), depth0))
	    + "\">\n  <h4>"
	    + alias2(alias1(((stack1 = ((stack1 = (depth0 != null ? depth0.reading : depth0)) != null ? stack1.book : stack1)) != null ? stack1.title : stack1), depth0))
	    + " by "
	    + alias2(alias1(((stack1 = ((stack1 = (depth0 != null ? depth0.reading : depth0)) != null ? stack1.book : stack1)) != null ? stack1.author : stack1), depth0))
	    + "</h4>\n  <p class=\"list-data\">Published In: "
	    + alias2(alias1(((stack1 = ((stack1 = (depth0 != null ? depth0.reading : depth0)) != null ? stack1.book : stack1)) != null ? stack1.published_in : stack1), depth0))
	    + "</p>\n  <p class=\"list-data\">Status: <div class=\"dropdown status-dropdown\">\n    <a href=\"#\" class=\"dropdown-toggle\" data-toggle=\"dropdown\" aria-haspopup=\"true\" aria-expanded=\"true\" data-id=\"status-"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.reading : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\">\n      "
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.reading : depth0)) != null ? stack1.status : stack1), depth0))
	    + "\n    </a>\n    <ul class=\"dropdown-menu\" aria-labelledby=\"dropdownMenu"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.reading : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\">\n      <li><a class=\"status-option\" href=\"#\" data-status=\"unread\" data-id=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.reading : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\">Unread</a></li>\n      <li><a class=\"status-option\" href=\"#\" data-status=\"started\" data-id=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.reading : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\">Started</a></li>\n      <li><a class=\"status-option\" href=\"#\" data-status=\"read\" data-id=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.reading : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\">Read</a></li>\n    </ul>\n  </div></p>\n  <p class=\"list-data\">"
	    + ((stack1 = helpers["if"].call(depth0 != null ? depth0 : {},((stack1 = ((stack1 = (depth0 != null ? depth0.reading : depth0)) != null ? stack1.book : stack1)) != null ? stack1.description : stack1),{"name":"if","hash":{},"fn":container.program(1, data, 0),"inverse":container.program(3, data, 0),"data":data})) != null ? stack1 : "")
	    + "</p>\n</div>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<button type=\"button\" class=\"btn btn-primary removeReading\" data-id=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.reading : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\" data-book=\""
	    + alias2(alias1(((stack1 = ((stack1 = (depth0 != null ? depth0.reading : depth0)) != null ? stack1.book : stack1)) != null ? stack1.id : stack1), depth0))
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<h2>Explore Books!</h2>\n<p>Enter search terms below, or leave empty to get ALL OF THE BOOKS!</p>\n<form id=\"bookSearch\">\n  <fieldset>\n    <label>\n      Title\n      <input type=\"text\" name=\"title\" placeholder=\"Title\">\n    </label>\n    <label>\n      Author\n      <input type=\"text\" name=\"author\" placeholder=\"Author\">\n    </label>\n    <button type=\"submit\" class=\"btn btn-primary\">Get Books!</button>\n  </fieldset>\n</form>\n\n"
	    + ((stack1 = container.invokePartial(__webpack_require__(42),depth0,{"name":"create-book-modal","data":data,"helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
